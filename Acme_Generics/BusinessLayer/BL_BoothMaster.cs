...
namespace BusinessLayer
{
    public class BL_BoothMaster
    {
        ...
        public DataTable GetBoothDisplayData(string strWhere)
        {
            DL_BoothMaster _DataLayer = new DL_BoothMaster();
            try
            {
                return _DataLayer.DL_GetBoothDisplayData(strWhere.Trim());
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
        ...
        public string BL_Save_BoothMaster(PL_BoothMaster objFields)
        {
            DL_BoothMaster _DataLayer = new DL_BoothMaster();
            try
            {
                return _DataLayer.DL_Save_BoothMaster(objFields);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
        ...
        public DataTable BL_GetBoothCode(string strPlantCode)
        {
            DL_BoothMaster _DataLayer = new DL_BoothMaster();
            try
            {
                return _DataLayer.DL_GetBoothCode(strPlantCode);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
