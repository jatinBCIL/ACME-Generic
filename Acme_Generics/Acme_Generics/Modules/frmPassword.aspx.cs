...
public partial class Tools_frmPassword : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
           ...
           txtUsername.Text = clsStandards.current_Username().ToString();
        }
    }
    ...
    protected void btnChangePassword_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            clsStandards.WriteLog(this, new Exception(_Common.ChangePassword(clsStandards.current_Username(), txtPassword.Text.Trim(), txtNewPassword.Text.Trim())), clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 2, true);
