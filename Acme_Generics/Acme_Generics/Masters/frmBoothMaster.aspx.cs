...
public partial class frmBooth_Master : System.Web.UI.Page
{
    ...
    protected void imgSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            objField.strStorageLocation = rbBType1.Checked == true ? "1" : (rbBType2.Checked == true ? "0" : "2");
    ...
    protected void imgExport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            clsxlsExport.ConvertToxls(objMaster.GetBoothDisplayData(clsStandards.WhereStatement_NoST(cboSearch.SelectedValue, cboCriteria.SelectedValue, txtSearch.Text.Trim())), "User_Master");
        }
        catch (Exception ex)
        {
            clsStandards.WriteLog(this, ex, clsStandards.GetCurrentPageName(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), 0, true);
