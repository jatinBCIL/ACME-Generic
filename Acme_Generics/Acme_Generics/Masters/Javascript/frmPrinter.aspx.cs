...
/// <summary>
/// Ref No : 
/// Purpose : Transaction of Printer Master
/// Created By : 
/// Created On : 
/// Modified By : Mayur Morye
/// Modified On : 29 July 2016
/// Comment : Presentation Layer functions of Printer Master Module
/// </summary>


public partial class Masters_frmPrinter : System.Web.UI.Page
{
        ...
        try
        {
            for (int i = 0; i < GrPrinter_Grid.Rows.Count; i++)
            {
                ...
                if (GrPrinter_Grid.Rows[i].Cells[0].Text == clsStandards.current_Plant())
                {
                    ...
                    obj.strPrinterCode = GrPrinter_Grid.Rows[i].Cells[2].Text;
                    obj.strPrinterIp = GrPrinter_Grid.Rows[i].Cells[3].Text;
                    obj.strPrinterPort = Convert.ToInt32(GrPrinter_Grid.Rows[i].Cells[4].Text);
                    obj.strBoothCode = GrPrinter_Grid.Rows[i].Cells[5].Text;
                    obj.strRemark = "";
        ...
        if (e.CommandName == "Select")
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    try { ddlBooth.SelectedValue = dt.Rows[0]["BOOTHCODE"].ToString().Trim(); }
                    catch { }
