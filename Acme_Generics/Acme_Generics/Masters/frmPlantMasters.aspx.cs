...
public partial class Masters_frmPlantMasters : System.Web.UI.Page
{
    ...
    public void InsertPlantMaster()
    {
        ...
        try
        {
            ...
            obj.strAddress1 = txtAddress1.Text;
            obj.strAddress2 = txtaddress2.Text;
            obj.strAddress3 = txtaddress3.Text;
            obj.strAddress4 = txtaddress4.Text;
            ...
            try
            {
                ...
                if (dt.Rows.Count != 0)
                {
                   ...
                   // txtHoldDays.Text = dt.Rows[0]["HOLDDAYS"].ToString();
                    ...
                    txtstate.Text = dt.Rows[0]["ADDRESS5"].ToString();
                    txtcity.Text = dt.Rows[0]["ADDRESS6"].ToString();
